...
from stable_baselines3.commons.buffers import DictRolloutBuffer, RolloutBuffer
from stable_baselines3.commons.callbacks import BaseCallback
from stable_baselines3.commons.policies import ActorCriticPolicy
from stable_baselines3.commons.type_aliases import GymEnv, MaybeCallback, Schedule
from stable_baselines3.commons.utils import obs_as_tensor, safe_mean
...
class OnPolicyAlgorithm(BaseAlgorithm):
    ...
    def _dump_logs(self, iteration: int) -> None:
        ...
        if len(self.ep_info_buffer) > 0 and len(self.ep_info_buffer[0]) > 0:
            ...
            # self.logger.record("rollout/ep_reward", [ep_info["r"] for ep_info in self.ep_info_buffer])
