...
from stable_baselines3.commons.vec_env.base_vec_env import VecEnv, VecEnvIndices, VecEnvObs, VecEnvStepReturn
from stable_baselines3.commons.vec_env.patch_gym import _patch_env
from stable_baselines3.commons.vec_env.util import dict_to_obs, obs_space_info
...
class DummyVecEnv(VecEnv):
    ...
    def env_is_wrapped(self, wrapper_class: Type[gym.Wrapper], indices: VecEnvIndices = None) -> List[bool]:
        ...
        from stable_baselines3.commons import env_util
